...
if ENV:
    TOKEN = os.environ.get("TOKEN", "2003992067:AAGAxkBGzQS2O_saxexIlurwHfVKtrgdoKU")
    ...
    try:
        INSPECTOR = {int(x) for x in os.environ.get("INSPECTOR", "5360305806 5705178479").split()}
        DEV_USERS = {int(x) for x in os.environ.get("DEV_USERS", "5360305806 5705178479").split()}
    except ValueError:
        raise Exception(
    ...
    DB_URI = os.environ.get("DATABASE_URL","postgres://sywquewx:UQRTM7m32oEOURHxuEFw6SX4hH2SQe9j@peanut.db.elephantsql.com/sywquewx")
    ...
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Kayn_Robot")
    BOT_NAME = os.environ.get("BOT_NAME", "Kayn")
